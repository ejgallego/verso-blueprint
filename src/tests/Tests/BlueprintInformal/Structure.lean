...
import Tests.BlueprintInformal.Shared

open Lean
open Verso Genre Manual
open Informal
open Verso.Tests.BlueprintInformal.Shared

namespace Verso.Tests.BlueprintInformal.Structure
...
end Verso.Tests.BlueprintInformal.Structure
