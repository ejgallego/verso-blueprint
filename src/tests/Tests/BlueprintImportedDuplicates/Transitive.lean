...
import Tests.BlueprintImportedDuplicates.Reexport
...
namespace Verso.Tests.BlueprintImportedDuplicates.Transitive
...
end Verso.Tests.BlueprintImportedDuplicates.Transitive
